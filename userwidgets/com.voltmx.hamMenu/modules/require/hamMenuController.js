define(function() {
  ...
  return {
    ...
    initGettersSetters: function() {
      ...
      defineGetter(this, 'isfrmBallImgVisible', () => {
        return this._isfrmBallImgVisible;
      });
      defineSetter(this, 'isfrmBallImgVisible', value => {
        this._isfrmBallImgVisible = value;
      });
    },
    ...
    setMenuVisibility: function(isVisible,menuItemObject) {
      ...
      if (isVisible) {
        ...
        switch (item) {
          case 'トップ': 
            var ntf = new voltmx.mvc.Navigation("frmBallImg");
      		ntf.navigate();
            break;
         case 'SMS': 
            var ntf = new voltmx.mvc.Navigation("frmSMS");
      		ntf.navigate();
            break;
         case 'メール': 
            var ntf = new voltmx.mvc.Navigation("CopyfrmMail");
      		ntf.navigate();
            break;
         case 'マップ': 
            var ntf = new voltmx.mvc.Navigation("frmMap");
      		ntf.navigate();
            break;
        }
      ...
      //voltmx.application.destroyForm("formBallImg");
